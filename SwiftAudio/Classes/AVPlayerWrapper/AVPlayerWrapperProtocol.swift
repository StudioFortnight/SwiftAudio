...
protocol AVPlayerWrapperProtocol: class {
    ...
    func load(from url: URL, playWhenReady: Bool, options: [String: Any]?, bitRate: Double)
    
    func load(from url: URL, playWhenReady: Bool, initialTime: TimeInterval?, options: [String: Any]?, bitRate: Double)
